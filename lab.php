...
<body>
	<div id="header">
		<a href="index.html" class="logo"><h1>METRO LAB</h1> your helth your choice</a>
	  <ul>
			<li >
...
<label for="PIN"></label>
	    ...
	    <p><label>LABORATORY LICENCE NO</label>
         <input type="text" name="LICENCENO" id="LICENCENO">
        &nbsp; </p>
	    <p>OWNER INFORMATION</p>
	    <p>
	      <label for="NAME2">OWNER NAME </label>
          <label for="NAME4"> </label>
          <input type="text" name="NAME2" id="NAME4">
        </p>
        <p>
  ...
  <input type="text" name="PIN2" id="PIN2">
        ...
        <p>
          ...
          <input type="text" name="E-MAIL2" id="E-MAIL2">
        </p>
	    <p>
	    ...
	    <p>
	      <label for="AADAR NO">AADAR NO</label>
	      <input type="text" name="AADAR NO" id="AADAR NO">
      </p>
	    <p>submit
